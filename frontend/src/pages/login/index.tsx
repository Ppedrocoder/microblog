            ...
            <div className="flex flex-row items-center justify-center w-full h-screen">
                ...
                <div className="w-full h-full">
                    <div className="container w-full h-full flex flex-col items-center justify-center">
                        <form className="br-modal w-100 h-115">
                            ...
                            <button className="mx-auto mb-4 br-button primary !w-40">Entrar</button>
                            <div className="mx-auto flex flex-col gap-0.5 text-center">
                                ...
                                <Link to="/cadastro" className=" self-center text-sm" style={linkStyle} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                    cadastre-se
                                </Link>
                            </div>
                        </form>
