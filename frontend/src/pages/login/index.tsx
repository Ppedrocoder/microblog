...
export default function Login() {
	...
	async function onSubmit(data: LoginData) {
		try {
			setCarregando(true);
			const { data: tokens } = await api.post("/login/", {
		...
		<>
			<div className="flex flex-row items-center justify-center w-full h-screen">
				...
				<div className="relative w-full h-full">
					<div
						className={`absolute right-0 br-message danger transition-opacity duration-300 ${messageLogin ? "opacity-100" : "opacity-0 pointer-events-none"}`}
					>
						<div className="icon">
							<i
					...
					<div className="container w-full h-full flex flex-col items-center justify-center">
						<form
							...
							className="br-modal w-120 h-115"
						>
							<h1 className="mx-auto pt-8 !font-bold !text-4xl">
								Login
							</h1>
							...
							<div className="mx-auto flex flex-col gap-0.5 text-center">
								...
								<Link
									to="/cadastro"
									className=" self-center text-sm mb-1"
									style={linkStyle}
