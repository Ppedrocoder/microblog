		...
		<>
			<div className="flex flex-row items-center justify-center w-full h-screen">
				...
				<div className="relative w-full h-full">
					<div
						className={`absolute right-0 br-message danger transition-opacity duration-300 ${messageCadastro ? "opacity-100" : "opacity-0 pointer-events-none"}`}
					>
						<div className="icon">
							<i
					...
					<div className="w-full h-full">
						<div className="container w-full h-full flex flex-col items-center justify-center">
							<form
								...
								className="br-modal w-120 h-180"
							>
								<h1 className="mx-auto pt-4 !font-bold !text-4xl">
									Cadastro
								</h1>
