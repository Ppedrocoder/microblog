# HU 0004 - Visualizar Postagens

### Histórico de Alterações

| Data | Autor | Observação |
| ----- | ----- | ------------ |
| 12/06/26 | @Ppedrocoder | Criação da ISSUE e escrita da HU |   

## 1. Especificação da História de Usuário

- **Como:** Visitante ou usuário autenticado do site
...
- **DADO** Que sou um visitante do site ou usuário autenticado
